...
public $pwd        = "quotesdb";  //   with quotesdb permissions     public $defaultDB = "quotesdb";
...
if ($this->db == NULL)
{
if($useDB != "") // use specified default DB, if provided
$this->defaultDB = $useDB;
$this->db =
@new mysqli($this->host, $this->user, $this->pwd, $this->defaultDB);
